<?php
	...
	$rnew_password= md5(md5(mysqli_real_escape_string($con,$_POST['newPassword'])));
    $email=$_SESSION['email'];
    //echo $email;
	
    $password_from_database_query="select password from volunteers where email='$email'";
    ...
    if($row['password']==$old_password){
        $update_password_query="update volunteers set password='$new_password' where email='$email'";
